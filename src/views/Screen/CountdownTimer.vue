<template>
  ...
  >
    <div class="header">
      <span class="text-btn" @click="toggle()">{{ inTiming ? 'Пауза' : 'Старт'}}</span>
      <span class="text-btn" @click="reset()">Сброс</span>
      <span class="text-btn" @click="toggleCountdown()" :class="{ 'active': isCountdown }">Обратный отсчет</span>
    </div>
    <div class="content">
      <div class="timer">
        <input
