<template>
  <div class="link-handler" :style="handlerStyle">
    ...
    <a class="link" v-else-if="elementInfo.link" @click="turnTarget(elementInfo.link.target)">Слайд-страница {{elementInfo.link.target}}</a>
    <div class="btns">
      <div class="btn" @click="openLinkDialog()">Заменить</div>
      <Divider type="vertical" />
      <div class="btn" @click="removeLink(elementInfo)">Удалить</div>
    </div>
  </div>
</template>
