    ...
    <div class="configs">
      ...
      <div class="row">
        ...
        <div class="config-item">
          <Switch v-model:value="ignoreWebfont" v-tooltip="'Онлайн-шрифты по умолчанию игнорируются при экспорте. Если вы используете онлайн-шрифты в своих слайдах и хотите сохранить связанные стили после экспорта, вы можете отключить параметр «Игнорировать онлайн-шрифты», но имейте в виду, что это увеличит время экспорта.'" />
        </div>
      </div>
    </div>
