<template>
  <div class="table-generator">
    <div class="title">
      <div class="lef">стол {{endCell.length ? `${endCell[0]} x ${endCell[1]}` : ''}}</div>
    ...
    <div class="custom" v-else>
      <div class="row">
        <div class="label" style="width: 25%;">Строки:</div>
        <NumberInput
          :min="1"
          :max="20"
      ...
      <div class="row">
        <div class="label" style="width: 25%;">Столбцы:</div>
        <NumberInput
          :min="1"
          :max="20"
...
const insertCustomTable = () => {
  if (customRow.value < 1 || customRow.value > 20) return message.warning('Число строк/столбцов должно быть от 0 до 20!')
  if (customCol.value < 1 || customCol.value > 20) return message.warning('Число строк/столбцов должно быть от 0 до 20!')
